<template>
  <div
    class="my-auto mx-auto sm:grid-cols-3 md:my-4 md:mx-4 gap-x-auto gap-y-5 md:gap-7 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-7 2xl:grid-cols-10"
  >
