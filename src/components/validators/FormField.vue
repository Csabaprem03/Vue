<template>
    <div>
        ...
        <input @blur="handleBlur" :type="props.type" :class="inputClass" :name="props.name" class="outline-none border rounded-md block w-[400px] h-[45px] text-sm text-zinc-600 pl-4"
            v-model="value">
    </div>
